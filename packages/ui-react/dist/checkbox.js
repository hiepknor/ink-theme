...
export const Checkbox = forwardRef(function Checkbox({ 'aria-describedby': ariaDescribedBy, 'aria-invalid': ariaInvalid, className, density: densityOverride, description, error, id: idProp, label, ...props }, ref) {
    ...
    return (_jsxs("div", { className: "ink-ui-check-field", "data-density": density, children: [_jsxs("label", { className: "ink-ui-check-label", htmlFor: id, children: [_jsx("input", { ...props, ref: ref, id: id, type: "checkbox", className: classes('ink-ui-checkbox', className), "aria-describedby": describedBy(ariaDescribedBy, descriptionId, errorId), "aria-invalid": ariaInvalid ?? (error ? true : undefined) }), _jsx("span", { children: label })] }), description && _jsx("div", { className: "ink-ui-description ink-ui-check-copy", id: descriptionId, children: description }), error && _jsx("div", { className: "ink-ui-error ink-ui-check-copy", id: errorId, children: error })] }));
});
