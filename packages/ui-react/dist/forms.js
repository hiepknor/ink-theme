...
export const RadioGroup = forwardRef(function RadioGroup({ defaultValue, density: densityOverride, disabled, label, name, onValueChange, options, value, ...inputProps }, ref) {
    const density = useInkDensity(densityOverride);
    return _jsxs("fieldset", { ref: ref, className: "ink-ui-choice-group", "data-density": density, disabled: disabled, children: [_jsx("legend", { className: "ink-ui-label", children: label }), options.map((option) => _jsxs("label", { className: "ink-ui-check-label", children: [_jsx("input", { ...inputProps, className: "ink-ui-radio", type: "radio", name: name, value: option.value, disabled: option.disabled, checked: value === undefined ? undefined : value === option.value, defaultChecked: value === undefined ? defaultValue === option.value : undefined, onChange: (event) => onValueChange?.(event.currentTarget.value) }), _jsx("span", { children: option.label })] }, option.value))] });
});
